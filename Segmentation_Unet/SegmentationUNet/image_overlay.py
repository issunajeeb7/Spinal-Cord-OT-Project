...
parser.add_argument('-i', '--input', default='../segmentation dataset/segmentation dataset/test_images', help='path to input dir')
parser.add_argument(
    '--model',
...
out_dir = os.path.join('..', 'outputs', 'inference_results_unet')
